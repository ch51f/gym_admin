...
import {dataURL2Blob, getImgNaturalDimensions} from '../../utils/img';
...
export default class Page extends Component {
  ...
  onRichChange = (value, html, val) => {
    ...
    if(_.trim(val) == "") {
              ...
              dispatch({
                ...
                payload: {
                  ...
                  call: (img) => {
                    ...
                    form.setFieldsValue({gym_desc: JSON.stringify({ops: contents})})
                    form.setFieldsValue({gym_desc_html: html.replace(temp, img.host + img.url)})
                  }
                }
              })
            }
      ...
      form.setFieldsValue({gym_desc: value})
      ...
      <PageHeaderLayout title="基础配置">
      	<Card bordered={false}>
      		<Form onSubmit={this.handleSubmit}>
                ...
                <div>
                  <RichText change={this.onRichChange} content={"gym"} />
