...
@connect(({member, loading}) => ({
  loading: loading.effects['member/homeCheckinList'],
              ...
              renderItem={(item, i) => (
                <List.Item>
                  <Row className={styles.homeListItem} onClick={this._chooseItem.bind(this, i)}>
                    ...
                    <Col span={6}>{item.available_time_end ? getDateStr(item.available_time_end) : "-"}</Col>
                  </Row>
                </List.Item>
              )}
            />
              ...
              <Meta
                ...
                description={
                  <Row>
                    ...
                    <Col span={24} className={styles.homeItem}>
                      <label>上次签到：</label>
                      <span>{moment(member.last_create_ts * 1000).format('YYYY-MM-DD HH:mm')}</span>
                    </Col>
                    <Col span={24} className={styles.homeItem}>
